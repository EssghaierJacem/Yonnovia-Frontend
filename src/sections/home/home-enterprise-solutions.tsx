...
const ENTERPRISE_SOLUTIONS = [
  ...
  {
    icon: 'mdi:file-document-scan',
    title: 'Automatisation documentaire',
    description: 'Automatisation documentaire (OCR/IA)',
  },
  {
...
const TECH_STACK = [
  ...
  },
  {
    ...
    title: 'IA',
    description: 'Google AI, Deep Learning, NLP, Machine Learning',
  },
  {
    icon: 'logos:mongodb',
  ...
  },
  {
    ...
    title: 'Sécurité',
    description: "Authentification renforcée, e-KYC, logs et droits d'accès",
  },
];
