...
const CATEGORIES = [
  {
    ...
    icon: 'solar:user-rounded-bold' as IconifyName,
    color: 'primary.main',
    items: ['Apprentissage ludique', 'Coaching et entraide', 'Création et vente de projets'],
  },
  {
    ...
    color: 'info.main',
    items: [
      'Suivi et rapport de progrès',
      'Valeurs de responsabilité',
      "Éveil à l'entrepreneuriat",
    ],
  },
  {
    name: 'Pour les enseignants',
    icon: 'solar:book-bookmark-bold' as IconifyName,
    color: 'success.main',
    items: [
      'Contenus pédagogiques prêts',
      'Intégration possible en classe',
      'Certification en gestion projet',
    ],
  },
];
  ...
  const renderDescription = () => (
    ...
    >
      <m.div variants={varFade('inUp')}>
        <Typography variant="h2">Pourquoi choisir Mind'z'Kid ?</Typography>
      </m.div>

      <m.div variants={varFade('inUp')}>
        <Typography sx={{ color: 'text.secondary', maxWidth: 800, mx: 'auto' }}>
          Notre programme offre des avantages adaptés à chaque acteur de l'écosystème éducatif de
          l'enfant.
        </Typography>
      </m.div>
    </Stack>
